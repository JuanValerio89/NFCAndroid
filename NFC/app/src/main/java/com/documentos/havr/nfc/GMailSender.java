...
public class GMailSender extends javax.mail.Authenticator {
    ...
    //private String mailhost = "mail.carbopapel.com.mx"; // Carbopapel
    private String mailhost = "smtp.gmail.com"; // GMAIL
    private String user;
    ...
    public synchronized void sendMail(int tipo, String subject, String body, String sender, String recipients) throws Exception {
        try{
