...
public class ResistenciaSerie extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resistencia_serie);
    ...
    private void ResultadoRes() {
        ...
        switch (ResistenciasAgregadas) {
            ...
            case 4:
                ...
                Resultado = R1 + R2 + R3aaa + R4aa + R5a + R6;
                break;
            case 5:
                ...
                Resultado = R1 + R2 + R3aaaa + R4aaa + R5aa + R6a + R7;
                break;
            case 6:
                ...
                Resultado = R1 + R2 + R3aaaaa + R4aaaa + R5aaa + R6aa + R7a + R8;
                break;
        }
        ValRes.setText("Valor resistencia: " + Resultado + "Ω");
        String valor = ConvertirRes(Resultado);
    }
